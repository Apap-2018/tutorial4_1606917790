...
public class FlightController {
	...
	private String deletePilot(@RequestParam(value = "id") long id, Model model) {
		flightService.deleteFlightById(id);
		return "delete";
	}
	
	@RequestMapping(value = "/flight/view", method = RequestMethod.GET)
	private String viewPilot(@RequestParam(value = "flightNumber") String flightNumber, Model model) {
